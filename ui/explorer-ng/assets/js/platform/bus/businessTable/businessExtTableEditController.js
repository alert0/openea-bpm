...
app.controller('ctrl', [ '$scope', 'baseService', 'ArrayToolService', '$filter', function($scope, baseService, ArrayToolService, $filter) {
	...
	$scope.init = function() {
		...
		ToolsController.getEnum("org.openbpm.bus.api.constant.BusColumnCtrlType").then(function(data) {
			$scope.FieldControlType = data;
		});
		ToolsController.getEnum("org.openbpm.base.api.constant.ColumnType").then(function(data) {
