...
app.controller('ctrl', [ '$scope', 'baseService', 'ArrayToolService', '$filter', function($scope, baseService, ArrayToolService, $filter) {
	...
	$scope.init = function() {
		ToolsController.getEnum("org.openbpm.bus.api.constant.BusinessPermissionObjType").then(function(data) {
		...
		ToolsController.getEnum("org.openbpm.bus.api.constant.RightsType", true).then(function(data) {
			$scope.$apply(function() {
