...
app.controller('ctrl', [ '$scope', 'baseService', 'ArrayToolService', '$filter', function($scope, baseService, ArrayToolService, $filter) {
	...
	$scope.init = function() {
		...
		ToolsController.getEnum("org.openbpm.form.api.constant.FormCustDialogStyle").then(function(data) {
		...
		ToolsController.getEnum("org.openbpm.form.api.constant.FormCustDialogObjType").then(function(data) {
			$scope.$apply(function() {
