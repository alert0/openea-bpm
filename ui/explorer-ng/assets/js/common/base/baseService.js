	...
	$httpProvider.interceptors.push(function() {
	    return {
	      ...
	      'response': function(response) {
	    	  if(response.data && !response.data.isOk && response.data.code==="401" && window.location.href.indexOf("index") == -1
				  && (!window.location.href.endWith("bpm-explorer/") && !window.location.href.endWith("bpm-ui/") )){
