...
import org.openbpm.base.db.datasource.DynamicDataSource;
...
public class DataSourceAutoConfiguration {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource,SaveInterceptor saveInterceptor) {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolveMapperLocations("classpath*:org/openbpm/**/mapping/*.xml", "classpath*:org/openea/**/mapping/*.xml"));
 ...
 // DAO 层 BasePackage TODO 可配置
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("org.openbpm.**.dao");
