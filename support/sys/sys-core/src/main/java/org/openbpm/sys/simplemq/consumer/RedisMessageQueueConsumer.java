package org.openbpm.sys.simplemq.consumer;
        ...
        public void run() {
            while (!Thread.interrupted()) {
                ...
                if (jmsDTO == null) {
                    ...
                    LOGGER.warn("Redis消息队列({})返回数据类型({})非[org.openbpm.sys.api.jms.model.JmsDTO]", JmsDestinationConstant.DEFAULT_NAME, jmsDTO.getClass());
                    continue;
                }
