...
(
  ...
  DEFAULT CHARSET = utf8
  COLLATE utf8_bin COMMENT ='任务候选人';
...
(
  ...
  DEFAULT CHARSET = utf8
  COLLATE utf8_bin COMMENT ='流程任务审批记录';
...
(
  ...
  DEFAULT CHARSET = utf8
  COLLATE utf8_bin COMMENT ='流程执行堆栈树';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务对象数据提交日志';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='流程催办触发';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='流程催办日志';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务流程用户代理配置';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务流程用户代理日志';
-- 业务对象、以及表单模块的表创建语句
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务字段表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='字段控件表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='业务对象';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='bo权限';
...
(
  ...
  COLLATE utf8_bin COMMENT ='自定义对话框';
